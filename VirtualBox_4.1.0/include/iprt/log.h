...
/** @def LogZ
 * Hypervisor logging, only emitted into LOG_GROUP_ZYPERVISOR, as loglevel 1.
 */
#define LogZ(a)    LogIt(LOG_INSTANCE, RTLOGGRPFLAGS_LEVEL_1, LOG_GROUP_ZYPERVISOR, a)

/** @def LogZ2
 * Hypervisor logging, only emitted into LOG_GROUP_ZYPERVISOR, as loglevel 2.
 */
#define LogZ2(a)    LogIt(LOG_INSTANCE, RTLOGGRPFLAGS_LEVEL_2, LOG_GROUP_ZYPERVISOR, a)

/** @def LogZ3
 * Hypervisor logging, only emitted into LOG_GROUP_ZYPERVISOR, as loglevel 3.
 */
#define LogZ3(a)    LogIt(LOG_INSTANCE, RTLOGGRPFLAGS_LEVEL_3, LOG_GROUP_ZYPERVISOR, a)

/** @def LogZ4
 * Hypervisor logging, only emitted into LOG_GROUP_ZYPERVISOR, as loglevel 4.
 */
#define LogZ4(a)    LogIt(LOG_INSTANCE, RTLOGGRPFLAGS_LEVEL_4, LOG_GROUP_ZHYPERVISOR, a)
