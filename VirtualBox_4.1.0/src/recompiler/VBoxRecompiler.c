...
*   Global Variables                                                           *
*******************************************************************************/
extern STAMCOUNTER    gStatcInsTotal;
...
REMR3DECL(int) REMR3Init(PVM pVM)
{
    ...
    //STAMR3RegisterF(pVM, &gStatRunCodeQEmu, STAMTYPE_PROFILE, STAMVISIBILITY_ALWAYS, STAMUNIT_TICKS_PER_CALL, "Number of the ins blocks for REM exec. The same as /PROF/REM/Runcode", "/PROF/CPU%d/EM/EIF/cInsREMa", 0);
    STAMR3RegisterF(pVM, &gStatRunCodeQEmu, STAMTYPE_COUNTER, STAMVISIBILITY_ALWAYS, STAMUNIT_OCCURENCES, "Number of the ins blocks for REM exec. The same as /PROF/REM/Runcode", "/PROF/CPU%d/EM/EIF/cInsREMa", 0);
...
void remR3ProfileStart(int statcode)
{
    ...
    case STATS_QEMU_RUN_EMULATED_CODE:
	 //STAM_COUNTER_INC(&gStatcInsTotal);
	 //uint64_t t = gStatcInsTotal.c;
