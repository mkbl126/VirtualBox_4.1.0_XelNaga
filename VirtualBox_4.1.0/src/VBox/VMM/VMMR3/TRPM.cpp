...
# endif
        ...
        PCPUMCTXCORE pRegFrame = CPUMCTX2CORE(pCtx);
        Log(("TRPMR3InjectEvent: CPU%d u8Interrupt=%d (%#x) rc=%Rrc EAX=%08X\n", pVCpu->idCpu, u8Interrupt, u8Interrupt, rc, pRegFrame->eax));
        if (RT_SUCCESS(rc))
        {
